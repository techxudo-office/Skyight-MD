...
const SupportChatPage = () => {
  ...
  return (
    <div
      className={`w-full min-h-screen ${themeClasses} transition-colors duration-300`}
    >
      {/* Header */}
            ...
            {filteredRooms.map((room) => (
              ...
              >
                <div className="flex items-start space-x-3">
                  <div className="relative">
                    <div className="flex items-center justify-center w-12 h-12 font-semibold text-white bg-teal-600 rounded-full">
                      {room.userAvatar}
                    </div>
                    {room.isOnline && (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {room.unreadCount > 0 && (
                      <div className="mt-1">
                        <span className="inline-flex items-center px-2 py-1 text-xs font-medium text-white bg-teal-600 rounded-full">
                          {room.unreadCount}
                        </span>
                      </div>
                    )}
          ...
          {selectedRoom ? (
            <>
              ...
              <div className={`${cardClasses} border-b px-6 py-4`}>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="flex items-center justify-center w-10 h-10 font-semibold text-white bg-teal-600 rounded-full">
                      {
              ...
              <div className={`${cardClasses} border-t p-4`}>
                <div className="flex items-center space-x-3">
                  ...
                  <div className="relative">
                    ...
                    {showEmojiPicker && (
                      <div
                        className={`absolute bottom-full right-0 mb-2 p-3 rounded-lg shadow-lg border ${cardClasses} grid grid-cols-6 gap-2`}
                      >
                  ...
                  <button
                    ...
                    className="p-3 text-white transition-colors bg-teal-600 rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="flex items-center justify-center flex-1">
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-teal-100 rounded-full dark:bg-teal-900/20">
                  <FaRegCommentDots className="w-8 h-8 text-teal-600" />
                </div>
