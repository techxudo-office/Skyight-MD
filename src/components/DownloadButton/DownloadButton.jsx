...
const DownloadButton = () => {
    ...
    return (
        <>
            <div ref={printRef} className="absolute -left-[999px] mx-auto bg-white shadow-lg text-text rounded-md p-4">
                {/* Header */}
                ...
                <div className="grid grid-cols-3 gap-2 p-2 text-sm uppercase bg-gray-100 rounded-md">
                    <div className="flex flex-col justify-between h-20 p-2 py-4 text-sm rounded-lg bg-bluebg">
                        ...
                        <p className="text-sm font-semibold">C&M TRAVEL & TOURISM(PVT)LTD</p>
                    </div>
                    <div className="flex flex-col justify-between h-20 p-2 py-4 text-sm rounded-lg bg-bluebg">
                ...
                <div className="p-3 py-5 border-gray">
                    ...
                    <div className="flex items-center gap-3 p-2 mt-3 text-sm font-semibold border-l-4 text-gray bg-bluebg border-primary ">
                        <p className="flex items-center gap-3"><BsFillSuitcaseFill className="text-lg text-text" />Baggage Allowance: Total 20.0 KG (As per airline policy) </p>
                        <p className="flex items-center gap-3 px-4 border-l border-r border-lightgray"> <GiMeal className="text-xl text-text" /> Meal Included </p>
                        <p>ECONOMY</p>
                    </div>
                    ...
                    <table className="w-full text-sm border-collapse">
                        ...
                        <tbody>
                            {passengers.map((passenger, index) => (
                                <tr key={index} className="text-center border-b border-lightgray">
            ...
            <button className="p-2 border rounded-full hover:bg-slate-200 bg-bluebg border-primary text-primary " onClick={handleDownloadPdf}>
