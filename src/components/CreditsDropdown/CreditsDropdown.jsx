...
const CreditsDropdown = ({onClose,credits}) => {
    return (
        <div className="relative p-4 shadow-xl w-72 bg-neutral-100 text-text rounded-2xl">
            {/* Header */}
            <button onClick={onClose} className="absolute text-gray-500 hover:text-gray-700 top-3 right-3">
                <FaTimes size={18} />
            </button>
            ...
            <div className="mt-2 bg-white rounded-2xl">
                <div className="flex items-center gap-3 px-4 py-3 border-b border-neutral-100">
                    ...
                    <div className="flex flex-col items-start text-sm leading-4">
                        <span className="text-xs font-semibold text-gray-900 ">PKR {credits&&credits.toLocaleString()}</span>
